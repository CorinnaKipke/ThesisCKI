...
\usepackage{breqn}
\usepackage{placeins}
\renewcommand{\floatpagefraction}{.98}%get less float only pages f.e. 0.9 of the page must be covered by the figure, so that no text appears on the same page
