...
\label{sec:Fund_mag}
Magnetism is a physical phenomenon produced by the motion of electric charges, which results in attractive and repulsive forces between objects \cite{stevenson2010oxford}.
...
\subsection{Fundamental quantities of magnetism}
\label{subsec:Quant_mag}
